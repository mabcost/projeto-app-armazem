...
class activity_leitura : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val produtosLidos = intent.getStringArrayListExtra("itensDivididos2")
        val qtdProdutosLidos = intent.getStringArrayListExtra("qtdItens")
        ...
        var qtd = 0
                ...
                if (produtosLidos != null) {
                   ...
                   for (i in produtosLidos) {
                                ...
                                val obterProduto50 = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) {
                                    ...
                                    if (intentResult.contents != null) {
                                        if (intentResult.contents == x[0]) {
                                            ...
                                            val intent = Intent(this, activity_leitura2::class.java)
                       ...
                       if (n == 1) {
                           break
                       }  else {val intent = Intent(this, activity_listaprodutosfinal::class.java)
                           intent.putExtra("produtosLidos",ArrayList(produtosLidos))
                           intent.putExtra("qtdProdutosLidos",qtdProdutosLidos)
                           startActivity(intent)}
                    }
